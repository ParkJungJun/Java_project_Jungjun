...
public class S01_JavaSwing {
	...
	public static void main(String[] args) {
		// 프레임 인스턴트를 생성(초기에는 보이지 않는 상태)
		JFrame frame = new JFrame();
		// 컴포넌트 인스턴스들을 생성
		JButton button1 = new JButton("I am Button");
		JButton button2 = new JButton("I am not Button");
		...
		// 해당 프레임의 초기 위치를 설정(x: 모니터 왼쪽으로부터 얼마나 떨어져 있는가)
