...
/*
 ...
 -컴파일시에 무시되기 때문에 프로그램 실핼에 영향을 미치지 않는다
...
/*
 * 워크스페이스 내부 > 프로젝트 폴더 내부 > src 폴더 내부에 소스코드(.java)를 작성한다
 * Ctrl + F11을 눌렀을 때
...
public class A00_Hello {
	// Eclipse에서 빨간 줄이 생겼을 떄(에러) 그곳에 커서를 두고 F2를 누르면
	 ...
	 * - 자바의 main() 함수는 정의 부분에 하나라도 다른것이 있다면
	 *   프로그램의 시작 지점으로 인정되지 않는다
	 * - main() 함수의 범위는 {}로 지정한다
	 * - {}를 지정할 떄는 들여쓰기를 반드시 맞춰야 한다
	 */
	public static void main(String[] args) {
		 ...
		 *  2. '' 사이에 적는 것 :문자(Chracter), 문자를 하나만 적을 수 있다
		 *  3. 숫자를 적는 것 : 정수(Integer), 계산 가능
		 *  4. 소수를 적는 것 : 실수(Float, Double), 계산 가능
		 *  5. ture 또는 false를 적는 것 : 참/거짓(boolean)
		...
		// 문자열과 다른 타입을 + 하면 이어붙이기를 해준다
		System.out.println("오늘의 메뉴:" + "햄치즈볶음밥");
		System.out.println("가격:" + 9800 * 3 + "원");
		System.out.println("가격:" + 4000 + 4500 + "원");
		System.out.println("가격:" + (4000 + 4500) + "원");
		
		System.out.println("안경을 썼는가? " + true);
		System.out.println("밥값을 계산하였는가? " + false);
