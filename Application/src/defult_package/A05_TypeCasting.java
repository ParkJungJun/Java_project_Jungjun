...
public class A05_TypeCasting {
	...
	public static void main(String[] args) {
		...
		// 큰타입에서 작은 타입으로 변할때는 데이터 손상이 발생할 수 있기떄문에
		// 그냥은 넣을 수 없고 강제 형변환(타입 캐스팅) 필요하다
		...
		System.out.println(b1); // -56이 나온 이유는 -128에서 0을 거쳐 127까지 한바퀴를 돌고 남은 값 72가
								// 다시 -128부터 돌기 때문이다 
		...
		//정수타입에 들어갈때 항상 타입 캐스팅이 필요하다
		long l1 = (long)f1;
		
		System.out.println(l1);
		
		// short, char 모두 2byte이지만
		// short에는 음수값이 존재할 위험이 있으으모 타입 캐스팅이 필요하다
		char c1 = (char)s1;
		
		System.out.println(c1);
		
		// char 타입에는 short의 범위를 넘어가는 양의 정수가 있을 수 있으므로
		// 타입캐스팅이 필요하다
		s1 = (short)c1;
