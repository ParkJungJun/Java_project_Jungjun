...
public class D12_Calendar {
	...
	public static void main(String[] args) {
		...
		System.out.println("이번 달의 몇 번째 요일인가? " +now.get(Calendar.DAY_OF_WEEK_IN_MONTH));
		System.out.println("이번 달의 몇 번째 주인가? " +now.get(Calendar.WEEK_OF_MONTH));
		System.out.println("올해의 몇 번째 주인가? " +now.get(Calendar.WEEK_OF_YEAR));
		System.out.println("오전인가 오후인가? " +now.get(Calendar.AM_PM));
		System.out.println("오전인가? " + Calendar.AM);
		System.out.println("오후인가? " + Calendar.PM);
		 ...
		 * - a : 오전, 오후
		 */
		SimpleDateFormat sdf = new SimpleDateFormat("yy-MM-dd [hh:mm:ss.SSS] EEEE");
