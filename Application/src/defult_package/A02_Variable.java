...
public class A02_Variable {
	 ...
	 * # 변수 (variable)
	 *  
	 *  - 프로그밍 언어에서 데이터를 저장해 줄 수 있는 공간
	 *  - 변수는 어떤 데이터를 보관할 것인지 타입을 지정해야 한다
	 *  - 값을 한번도 대입한적 없는 변수는 사용하려고 하면 에러가 발생한다
	 ...
	 *   - 변수를 선언할 떄, 같은 {} 내부에서 같은 이름의 변수를 다시 선언 할 수 없다
	...
	public static void main(String[] args) {
		...
		// {} 내부의 변수인 menu가 사라졌기 떄문에 다시 menu라는 변수명을 사용할 수 있다
		String menu = "짜장면";
