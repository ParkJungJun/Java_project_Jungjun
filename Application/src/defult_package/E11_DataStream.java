...
public class E11_DataStream {
	...
	public static void main(String[] args) {
		try(FileOutputStream fout = new FileOutputStream("Files/data.abc");
		...
		try(FileInputStream fin = new FileInputStream("Files/data.abc");
		DataInputStream din = new DataInputStream(fin);){
			System.out.println("아까 쓴거1 " + din.readBoolean()); 
			System.out.println("아까 쓴거2 " + din.readDouble());
			System.out.println("아까 쓴거3 " + din.readUTF());
			System.out.println("아까 쓴거4 " + din.readInt());
			System.out.println("아까 쓴거5 " + din.readInt());
			System.out.println("아까 쓴거6 " + din.readInt());
		}catch(IOException e) {
			e.printStackTrace();
		}
	}
