...
public class A06_Print {
	...
	public static void main(String[] args) {
		...
		int hour = 19, minute = 17 , second = 30;
...
//		%d, %o, %x, %X
		...
		System.out.printf("10진수 값: %o\n", value);
		System.out.printf("10진수 값: %x\n", value);
		System.out.printf("10진수 값: %X\n", value);//대문자로 나온다
		
		// %f
		double weight = 88.88888888888888;
...
//		 %s : 원래는 문자열이지만 모든 타입은 문자열이 될 수 있기 때문에 아무거나 전달해도 된다
		System.out.printf("문자열: %s\n", "hello");
		System.out.printf("문자열: %s\n", 123);
		System.out.printf("문자열: %s\n", 123.123456789);
		
//		printf()  내부에서는 %는 특수 기호이기 때문에 그냥 출력할 수 없다
		System.out.printf("성공 확률 %.2f%%\n", 99.99);
