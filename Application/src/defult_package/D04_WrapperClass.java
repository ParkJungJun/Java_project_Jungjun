...
public class D04_WrapperClass {
	...
	public static void main(String[] args) {
		 ...
		 * - 각 타입 클래스마다 parseXXX 매서드가 존재한다
		 * 
		 * 
		 */
		
		String value = "12345";
		String value2 = "123.4567";
		String value3 = "10010";
		...
		System.out.println("대문자인가요? " + Character.isUpperCase('d'));
		System.out.println("대문자인가요? " + Character.isUpperCase('o'));
		char ch = 'a';
		System.out.println("영문자인가요? " +( Character.isUpperCase(ch) || 
		...
		System.out.println("자바 변수 첫번째 글자로 사용할 수 있나요?");
		...
		System.out.println("자바 변수에 사용되는 문자인가요?");
