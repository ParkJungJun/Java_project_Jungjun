...
public class C07_ReferencesDateType {
	/*
	 * 
	 * # 기본형 데이터 타입
	 * 
	...
	public static void main(String[] args) {
		...
		// 모든 클래스는 데이터 타입이다..
		// Apple 타입 인스턴스(실제의 주소)를 Apple 타입 변수에 담을 수 있다
		Apple a1 = new Apple();
		...
		//이러한 특징은 함수의 매개변수로 전달될 때에도 다른 결과를 초래한다
		int test = 5;
	...
	// 매개변수에 기본형 변수 타입을 활용할 때에는 값이 전달된다 (같은 실체를 참조하지 않음)
	public static void plusPrimitive(int num) {
		num = num + 100;
	}
	
	// 매개변수에 참조형 변수 타입을 활용할 때에는 주소값이 전달된다 (같은 실제를 참조함)
