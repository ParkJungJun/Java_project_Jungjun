...
public class B14_Arrary2 {
	...
	public static void main(String[] args) {
		...
		// arr4를 수정하면 원래 aar1이 가리키고 있던 배열의 값을 바꾼다
		int[] arr4 =arr1;
		// aar5는 있던 배열의 주소를 넘겨받은 것이 아니라
		...
		//n차면 배열은 n중 반복문으로 모두 탐색할 수 있다
		int[][] nums = {
			{1,2,3},
			{4,5,6,7,8,9},
			{99,100,15,20},
		};
		// nums.length : 배열 안에 들어있는 배열이 몇개인지
		for(int i= 0; i < nums.length; ++i) {
			
			// nums[i].length : 1번째 배열의 요소가 몇 개인지
