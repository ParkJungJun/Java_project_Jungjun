...
public class E01_Exception {
	 ...
	 * - 예외 처리의 기본 동작은 e.StackTrace() 후 프로그램 강제 종료이다
	 * 
	 * # StackTrace
	 * 
	 * - 현재 스택에서 일어나고 있던 일들을 기록해놓은 것
	 * - 에러 발생 시 상태를 콘솔에 출력하여 예외가 발생한 위치를 찾는데 도움을 준다
	 * 
	 * # finally
	 * 
	 * - try문 내부에서 예외가 발생하던 안하던 무조건 출력한다
	 * 
	 */
	public static void main(String[] args) {
		...
		try{
			...
			System.err.println("내가 정수만 입력하라고 했찌!");
		}finally {
			System.out.println("/)/)");
			System.out.println("( ..)");
			System.out.println("( >$)");
