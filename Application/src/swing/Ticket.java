...
public class Ticket {
    ...
    public class RoundedButton extends JButton {
        ...
        protected void paintComponent(Graphics g) {
           Color c=new Color(0,128,128); //배경색 결정
	...
	private void initialize() {
		...
		ticket_panel.setBounds(450, 250, 1000, 600);
		...
		starting_time.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 35));
		...
		JLabel seat_num_image = new JLabel(img3);
		...
		train_num.setFont(new Font("굴림", Font.PLAIN, 30));
		...
		seat_num.setFont(new Font("굴림", Font.PLAIN, 30));
		...
		train_food_image.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 30));
		...
		train_food_1.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 25));
		train_food_1.setBounds(650, 175, 200, 50);
		ticket_panel.add(train_food_1);
		
		JLabel train_food_2 = new JLabel(" 콜라");
		train_food_2.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 25));
		...
		food_1_count.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 25));
		food_1_count.setBounds(850, 175, 50, 50);
		ticket_panel.add(food_1_count);
		
		JLabel food_2_count = new JLabel("1");
		food_2_count.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 25));
		...
		ticket_num.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 15));
		...
		ticket_date.setFont(new Font("휴먼둥근헤드라인", Font.PLAIN, 30));
		ticket_date.setBounds(500, 200, 460, 53);
		frame.getContentPane().add(ticket_date);
		
		JLabel ticket_top_image_blue = new JLabel(img1);
		ticket_top_image_blue.setBounds(450, 195, 1000, 59);
		frame.getContentPane().add(ticket_top_image_blue);
		
		JButton payment_btn = new JButton(img5);
		payment_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		train_food_image.setOpaque(true);
		payment_btn.setBackground(new Color(0, 255, 255));
		payment_btn.setBounds(1550, 900, 277, 70);
